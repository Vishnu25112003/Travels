    ...
    <section id="contact" className="relative bg-white pb-12 md:pb-20">
      ...
      <div className="relative h-[45vh] md:h-[85vh]">
        ...
        <div className="absolute left-4 right-4 top-6 md:left-8 md:top-10">
          <h2 className="text-primary  text-3xl md:text-5xl font-bold drop-shadow-sm">
            Get In Touch
          </h2>
          <p className="mt-2 text-white/80 text-sm md:text-base max-w-xl drop-shadow">
            We’d love to help plan your next adventure. Send us your details and
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition resize-none"
                    placeholder="Tell us about your travel plans..."
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full px-5 py-2.5 bg-primary text-white rounded-lg font-semibold hover:bg-orange-600 transition-colors duration-200 shadow-md"
                >
                  Send Message
                </button>
              </form>
